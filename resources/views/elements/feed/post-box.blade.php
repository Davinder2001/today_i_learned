    ...
    <div class="post-content mt-3  pl-3 pr-3 upvote_downvote_section">
        ...
        <div class="post-text-area-main">
            ...
            <div class="post-link-and-tag">
                ...
                <!--<div class="post-catogiry-section">-->
                <!--    {{-- Code for showing Post id and interest category in post --}}-->
                <!--    {{-- {{ $post->id }} --}}-->
                <!--    @if ($post->interests->isNotEmpty())
-->
                <!--        @foreach ($post->interests as $interest)
-->
                <!--            <a class='post-tag'>-->
                <!--                @if ($interest->name == 'Finance')
-->
                <!--                    {{ $interest->name }} <i class="fas fa-money-bill-wave"></i>-->
                <!--
@elseif ($interest->name == 'Health')
-->
                <!--                    {{ $interest->name }} <i class="fas fa-heartbeat"></i>-->
                <!--
@elseif ($interest->name == 'Nature')
-->
                <!--                    {{ $interest->name }} <i class="fas fa-tree"></i>-->
                <!--
@elseif ($interest->name == 'News')
-->
                <!--                    {{ $interest->name }} <i class="fas fa-newspaper"></i>-->
                <!--
@elseif ($interest->name == 'Sports')
-->
                <!--                    {{ $interest->name }} <i class="fas fa-football-ball"></i>-->
...
@endforeach-->
                <!--
@endif-->
                <!-- END interest Need to remove code-->
                <!--</div>-->
